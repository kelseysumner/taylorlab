...
path <- "/Users/kelseysumner/Desktop/Meshnick Lab/Steve Taylor's Lab/Webuye MESA Sequence Data/Mapped Cut Reads/AMA_haplotypes/AMA/input_fastqs" 
list.files(path)
...
saveRDS(seqtab.nochim, "/Users/kelseysumner/Desktop/Meshnick Lab/Steve Taylor's Lab/Webuye MESA Sequence Data/Mapped Cut Reads/AMA_haplotypes/AMA/MESA_AMA_haplotypes.rds")
...
write.csv(track, "trackReadsThroughPipeline.csv")
...
# read in the path to your folder of fastq files for AMA
path <- "/Users/kelseysumner/Desktop/Meshnick Lab/Steve Taylor's Lab/Webuye MESA Sequence Data/Mapped Cut Reads/CSP_haplotypes/input_fastqs" 
list.files(path)
...
# write out the results without chimeras
saveRDS(seqtab.nochim, "/Users/kelseysumner/Desktop/Meshnick Lab/Steve Taylor's Lab/Webuye MESA Sequence Data/Mapped Cut Reads/CSP_haplotypes/MESA_CSP_haplotypes.rds")
...
# read in the path to your folder of fastq files for AMA
path <- "/Users/kelseysumner/Desktop/Meshnick Lab/Steve Taylor's Lab/Webuye MESA Sequence Data/Mapped Cut Reads/HistB_haplotypes/input_fastqs" 
list.files(path)
...
# learn the error rates for your amplicon data set
errF <- learnErrors(filtFs, multithread=FALSE)
errR <- learnErrors(filtRs, multithread=FALSE, MAX_CONSIST=20) # converges after 13 steps
...
# write out the results without chimeras
saveRDS(seqtab.nochim, "/Users/kelseysumner/Desktop/Meshnick Lab/Steve Taylor's Lab/Webuye MESA Sequence Data/Mapped Cut Reads/HistB_haplotypes/MESA_HistB_haplotypes.rds")
