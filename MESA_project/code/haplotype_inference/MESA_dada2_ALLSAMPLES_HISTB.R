...
# read in the path to your folder of fastq files for HistB
...
saveRDS(seqtab.nochim, "/Users/kelseysumner/Desktop/test/MESA_HistB_haplotypes.rds")
...
write.csv(track, "HistBtrackReadsThroughPipeline.csv")
