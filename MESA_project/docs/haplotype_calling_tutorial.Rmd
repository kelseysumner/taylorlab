...
+ Example R script for cleaning initial haplotype output: `https://github.com/kelseysumner/taylorlab/haplotype_censoring_example.R`


# **Miscellaneous**

## Standardizing Ct values from qPCR results
* An example R script can be found at: `https://github.com/kelseysumner/taylorlab/Haplotype_calling_tutorial/qpcr_data_cleaning_example.R`
