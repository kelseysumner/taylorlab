...
final_data = read_rds("Desktop/Dissertation Materials/SpatialR21 Grant/Final Dissertation Materials/Final Data Sets/Cohort data through August July 2019/merged_data/final_merged_data/phase2_spat21_human_final_censored_data_for_dissertation_2DEC2019.rds")

# read in the consecutive monthly follow-up data set
followup_data = read_csv("Desktop/Dissertation Materials/SpatialR21 Grant/Final Dissertation Materials/Aim 1A/Consecutive Follow-up Tables/phase2_aim1a_consecutive_follow_up_order_df_after_censoring_2DEC2019.csv")
...
length(which(final_data$visit_type == "monthly and sick visit" & final_data$pf_pcr_infection_status == "positive" & final_data$rdt_rst == "positive" &
  !(final_data$pf_pcr_infection_status == "positive" & final_data$rdt_rst == "positive" &
                (final_data$fever == "yes" | final_data$Aches == "yes" | final_data$Vomiting == "yes" | final_data$Diarrhea == "yes" | final_data$Chills == "yes" | final_data$congestion =="yes" |
                   final_data$Cough =="yes" | final_data$Other == "yes")))) # 7 that meet this
table(main_exposure_primary_case_def,final_data$visit_type, useNA="always")
length(which(final_data$visit_type == "monthly and sick visit" & final_data$pf_pcr_infection_status == "positive" & final_data$rdt_rst == "positive" &
                   (final_data$fever == "yes" | final_data$Aches == "yes" | final_data$Vomiting == "yes" | final_data$Diarrhea == "yes" | final_data$Chills == "yes" | final_data$congestion =="yes" |
                      final_data$Cough =="yes" | final_data$Other == "yes"))) # 73 meet this
...
length(which(final_data$visit_type == "monthly and sick visit" & final_data$pf_pcr_infection_status == "positive"  &
               !(final_data$pf_pcr_infection_status == "positive" &
                   (final_data$fever == "yes" | final_data$Aches == "yes" | final_data$Vomiting == "yes" | final_data$Diarrhea == "yes" | final_data$Chills == "yes" | final_data$congestion =="yes" |
                      final_data$Cough =="yes" | final_data$Other == "yes")))) # 25 that meet this
table(main_exposure_secondary_permissive_case_def,final_data$visit_type, useNA="always")
length(which(final_data$visit_type == "monthly and sick visit" & final_data$pf_pcr_infection_status == "positive"  &
                  (final_data$fever == "yes" | final_data$Aches == "yes" | final_data$Vomiting == "yes" | final_data$Diarrhea == "yes" | final_data$Chills == "yes" | final_data$congestion =="yes" |
                     final_data$Cough =="yes" | final_data$Other == "yes"))) # 127 meet this
...
# export data sets
write_csv(final_data,"Desktop/phase2_spat21_human_final_censored_data_for_dissertation_with_exposure_outcome_2DEC2019.csv")
write_rds(final_data,"Desktop/phase2_spat21_human_final_censored_data_for_dissertation_with_exposure_outcome_2DEC2019.rds")
