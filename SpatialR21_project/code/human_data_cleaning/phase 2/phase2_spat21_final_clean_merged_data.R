...
final_merged_data_no_censoring = read_rds("Desktop/Dissertation Materials/SpatialR21 Grant/Final Dissertation Materials/Final Data Sets/Cohort data through August July 2019/merged_data/final_merged_data/phase2_spat21_human_merged_data_no_dbs_censoring_2DEC2019.rds")
...
length(unique(final_merged_data$sample_name_final)) # 5244 unique unique 
...
length(unique(final_merged_data$sample_name_dbs)) # 5244 unique unique 
...
# check for duplicate sample ids in the social demographic data sample ids
length(unique(final_merged_data_no_censoring$sample_name_final)) # 5485 unique unique 
...
# check for duplicate sample ids in the dbs sample ids
length(unique(final_merged_data_no_censoring$sample_name_dbs)) # 5245 unique unique 
length(which(is.na(final_merged_data_no_censoring$sample_name_dbs) == T)) # 241 missing
...
# final_merged_data
write_csv(final_merged_data,"Desktop/phase2_spat21_human_merged_data_with_dbs_censoring_2DEC2019.csv")
write_rds(final_merged_data,"Desktop/phase2_spat21_human_merged_data_with_dbs_censoring_2DEC2019.rds")

# final_merged_data_no_censoring
write_csv(final_merged_data_no_censoring,"Desktop/phase2_spat21_human_merged_data_no_dbs_censoring_2DEC2019.csv")
write_rds(final_merged_data_no_censoring,"Desktop/phase2_spat21_human_merged_data_no_dbs_censoring_2DEC2019.rds")
