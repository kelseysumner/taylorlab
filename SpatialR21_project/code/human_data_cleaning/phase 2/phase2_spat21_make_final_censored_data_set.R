...
final_merged_data = read_rds("Desktop/Dissertation Materials/SpatialR21 Grant/Final Dissertation Materials/Final Data Sets/Cohort data through August July 2019/merged_data/final_merged_data/phase2_spat21_human_merged_data_with_dbs_censoring_2DEC2019.rds")
length(unique(final_merged_data$unq_memID))
# note: 266 participants

# read in the old spat21 data set before merging
old_data = read_rds("Desktop/Dissertation Materials/SpatialR21 Grant/Final Dissertation Materials/Final Data Sets/Cohort data through August July 2019/merged_data/final_merged_data/interim data/phase2_spat21_human_merged_all_data_2DEC2019.rds")
length(unique(old_data$unq_memID))
# note: 271 participants
...
length(unique(final_merged_data$sample_name_final)) # 5237 unique 
...
length(unique(final_merged_data$sample_name_dbs)) # 5237 unique unique 
...
old_data %>% filter(unq_memID == "M13_3") %>% select(age_all_baseline,unq_memID,today_hum_monthly_data,today_hum_sick_data)
...
consecutive_follow_up_ordered_df <- consecutive_follow_up_ordered_df[,c("unq_memID","6-2017", "7-2017", "8-2017","9-2017","10-2017","11-2017","12-2017","1-2018","2-2018","3-2018","4-2018","5-2018","6-2018","7-2018","8-2018","9-2018","10-2018","11-2018","12-2018","1-2019","2-2019","3-2019","4-2019","5-2019","6-2019","7-2019")]


# export correct consecutive follow-up measures
write_csv(consecutive_follow_up_ordered_df,"Desktop/phase2_aim1a_consecutive_follow_up_order_df_after_censoring_2DEC2019.csv")


# write out the data frame with the final censoring criteria applied
write_csv(final_merged_data,"Desktop/phase2_spat21_human_final_censored_data_for_dissertation_2DEC2019.csv")
write_rds(final_merged_data,"Desktop/phase2_spat21_human_final_censored_data_for_dissertation_2DEC2019.rds")
