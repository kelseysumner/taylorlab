...
m1_df = bind_cols(tidy(model1), confint_tidy(model1)) %>% mutate(model_name="M1: plate28-29") %>% mutate(r_value = summary(model1)$r.squared)
m2_df = bind_cols(tidy(model2), confint_tidy(model2)) %>% mutate(model_name="M2: plate26-27") %>% mutate(r_value = summary(model2)$r.squared)
m3_df = bind_cols(tidy(model3), confint_tidy(model3)) %>% mutate(model_name="M3: plate2-3") %>% mutate(r_value = summary(model3)$r.squared)
m4_df = bind_cols(tidy(model4), confint_tidy(model4)) %>% mutate(model_name="M4: plate1") %>% mutate(r_value = summary(model4)$r.squared)
m5_df = bind_cols(tidy(model5), confint_tidy(model5)) %>% mutate(model_name="M5: plate32-33") %>% mutate(r_value = summary(model5)$r.squared)
m6_df = bind_cols(tidy(model6), confint_tidy(model6)) %>% mutate(model_name="M6: plate12-13") %>% mutate(r_value = summary(model6)$r.squared)
m7_df = bind_cols(tidy(model7), confint_tidy(model7)) %>% mutate(model_name="M7: plate14-15") %>% mutate(r_value = summary(model7)$r.squared)
m8_df = bind_cols(tidy(model8), confint_tidy(model8)) %>% mutate(model_name="M8: plate24-25") %>% mutate(r_value = summary(model8)$r.squared)
m9_df = bind_cols(tidy(model9), confint_tidy(model9)) %>% mutate(model_name="M9: plate22-23") %>% mutate(r_value = summary(model9)$r.squared)
m10_df = bind_cols(tidy(model10), confint_tidy(model10)) %>% mutate(model_name="M10: plate18-19") %>% mutate(r_value = summary(model10)$r.squared)
m11_df = bind_cols(tidy(model11), confint_tidy(model11)) %>% mutate(model_name="M11: plate34") %>% mutate(r_value = summary(model11)$r.squared)
m12_df = bind_cols(tidy(model12), confint_tidy(model12)) %>% mutate(model_name="M12: plate30-31") %>% mutate(r_value = summary(model12)$r.squared)
m13_df = bind_cols(tidy(model13), confint_tidy(model13)) %>% mutate(model_name="M13: plate4-5") %>% mutate(r_value = summary(model13)$r.squared)
m14_df = bind_cols(tidy(model14), confint_tidy(model14)) %>% mutate(model_name="M14: plate20-21") %>% mutate(r_value = summary(model14)$r.squared)
m15_df = bind_cols(tidy(model15), confint_tidy(model15)) %>% mutate(model_name="M15: plate16-17") %>% mutate(r_value = summary(model15)$r.squared)
m16_df = bind_cols(tidy(model16), confint_tidy(model16)) %>% mutate(model_name="M16: plate6-7") %>% mutate(r_value = summary(model16)$r.squared)
m17_df = bind_cols(tidy(model17), confint_tidy(model17)) %>% mutate(model_name="M17: plate10-11") %>% mutate(r_value = summary(model17)$r.squared)
m18_df = bind_cols(tidy(model18), confint_tidy(model18)) %>% mutate(model_name="M18: plate8-9") %>% mutate(r_value = summary(model18)$r.squared)
model_results_df = bind_rows(m1_df,m2_df,m3_df,m4_df,m5_df,m6_df,m7_df,m8_df,m9_df,m10_df,m11_df,m12_df,m13_df,
                             m14_df,m15_df,m16_df,m17_df,m18_df)
...
write_csv(model_results_simplified,"spat21_model_results_simplified_human_dbs.csv")
...
model_results = read_csv("/Users/kelseysumner/Desktop/Dissertation Materials/SpatialR21 Grant/Final Dissertation Materials/Final Data Sets/Final Cohort data June 2017 to July 2018/Human data/raw_files/qpcr_data/spat21_model_results_simplified_human_dbs.csv")
...
length(which(final_qpcr_merge$HbtubCT1 == "Undetermined" | final_qpcr_merge$HbtubCT1 == "0" | final_qpcr_merge$HbtubCT1 == "0.000")) # 23
length(which(final_qpcr_merge$HbtubCT2 == "Undetermined" | final_qpcr_merge$HbtubCT2 == "0" | final_qpcr_merge$HbtubCT2 == "0.000")) # 15
length(which(final_qpcr_merge$pfr364CT1 == "Undetermined" | final_qpcr_merge$pfr364CT1 == "0" | final_qpcr_merge$pfr364CT1 == "0.000")) # 1827
length(which(final_qpcr_merge$pfr364CT2 == "Undetermined" | final_qpcr_merge$pfr364CT2 == "0" | final_qpcr_merge$pfr364CT2 == "0.000")) # 1817
length(which(is.na(final_qpcr_merge$HbtubCT1))) # 0
length(which(is.na(final_qpcr_merge$HbtubCT2))) # 5
...
length(which(is.na(final_qpcr_merge$HbtubCT1))) # 23
length(which(is.na(final_qpcr_merge$HbtubCT2))) # 20
length(which(is.na(final_qpcr_merge$pfr364CT1))) # 1827
length(which(is.na(final_qpcr_merge$pfr364CT2))) # 1817
...
# export the data set
write_csv(final_qpcr_merge,"spat21_final_qpcr_merge_human_dbs.csv")
...
final_results = read_csv("/Users/kelseysumner/Desktop/Dissertation Materials/SpatialR21 Grant/Final Dissertation Materials/Final Data Sets/Final Cohort data June 2017 to July 2018/Human data/raw_files/qpcr_data/spat21_final_qpcr_merge_human_dbs.csv")
...
summary(final_results$pfr364Q1_std) # 1827 missing
summary(final_results$pfr364Q2_std) # 1817 missing
...
summary(final_results$pfr364Q1_std_censored_v2) # 1839 missing
summary(final_results$pfr364Q2_std_censored_v2) # 1832 missing
# check the output one more time
length(which(final_results$pfr364CT1 >= 38 & is.na(final_results$pfr364CT2))) # 12 observations
length(which(final_results$pfr364CT2 >= 38 & is.na(final_results$pfr364CT1))) # 15 observations
...
length(which(is.na(qpcr_data$HbtubCT1))) # 23
length(which(is.na(qpcr_data$HbtubCT2))) # 20
length(which(is.na(qpcr_data$pfr364CT1))) # 1805
length(which(is.na(qpcr_data$pfr364CT2))) # 1795
# still looks good
...
write_rds(qpcr_data, "spat21_qpcr_data_clean_human_dbs_16JAN2019.RDS")
