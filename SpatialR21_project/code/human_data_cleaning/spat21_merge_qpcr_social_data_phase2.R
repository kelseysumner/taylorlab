...
human_merged_all_data = read_rds("/Users/kelseysumner/Desktop/Dissertation Materials/SpatialR21 Grant/Final Dissertation Materials/Final Data Sets/Cohort data through August July 2019/merged_data/phase2_hum_monthly_merged_with_table_and_sick_19NOV2019.RDS")
...
human_merged_all_data_final$pf_pcr_infection_status = factor(human_merged_all_data_final$pf_pcr_infection_status,levels=c(1,2),labels=c("negative","positive"))
table(human_merged_all_data_final$pf_pcr_infection_status, useNA = "always")
