...
path <- "/data/taylorlab/kms94/haplotype_tutorial/out/fastq/CSP/all_samples" 
list.files(path)
...
write.csv(out,"/data/taylorlab/kms94/haplotype_tutorial/out/haplotype_output/CSP_trimAndFilterTable.csv")
...
saveRDS(seqtab.nochim, "/data/taylorlab/kms94/haplotype_tutorial/out/haplotype_output/CSP_haplotypes.rds")
...
write.csv(track, "/data/taylorlab/kms94/haplotype_tutorial/out/haplotype_output/CSP_trackReadsThroughPipeline.csv")
